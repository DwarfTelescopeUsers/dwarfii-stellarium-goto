  ...
  export const getExposureNameByIndex = (index) => {
    const foundOption = allowedExposures.values.find(option => option.index === index);
  ...
  export const getExposureIndexByName = (name) => {
    const foundOption = allowedExposures.values.find(option => option.name === name);
  ...
  export const getGainNameByIndex = (index) => {
    const foundOption = allowedGains.values.find(option => option.index === index);
    return foundOption ? foundOption.name : "Auto";
  };

  export const getGainIndexByName = (name) => {
    const foundOption = allowedGains.values.find(option => option.name === name);
